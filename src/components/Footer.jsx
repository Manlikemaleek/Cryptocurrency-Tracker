...
const Footer = () => {
  return (
    <div className='rounded-div mt-9 pt-9 text-primary'>
            ...
            <div className='text-right'>
                <div className='w-full flex justify-end'>
                    <div className='w-full md:w-[300px] py-4 relative'>
                        ...
                        <div className='py-4 '>
                            <form>
                                <input className='bg-primary border border-input p-2 mr-2 w-full shadow-xl rounded-2xl md:w-auto' type="email" placeholder='Enter your email address' />
        ...
        <p className='text-center py-4'>Built by Malik</p>
    </div>
  )
}
